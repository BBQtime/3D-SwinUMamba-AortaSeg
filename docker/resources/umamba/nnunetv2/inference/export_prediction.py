...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    #changes https://github.com/MIC-DKFZ/nnUNet/pull/2356/commits/7de855f2e834c8e86155d7103f8c069e1c4783c6
    ...
    if label_manager.has_regions or return_probabilities:
        ...
        segmentation = torch.from_numpy(predicted_logits).argmax(0).cpu().numpy() if isinstance(predicted_logits, np.ndarray) else predicted_logits.argmax(0).cpu().numpy()
        del predicted_logits
        print("time cost for softmax:", time.time()-start_time)
    ...
    if return_probabilities:
        ...
        print("torch.set_num_threads(old_threads)")
        torch.set_num_threads(old_threads)
