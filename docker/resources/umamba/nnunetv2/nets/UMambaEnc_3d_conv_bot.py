...
class ResidualMambaEncoder(nn.Module):
    def __init__(self,
        ...
        for s in range(n_stages):
            ...
            if s < 3: # 0,1,2 having mamba, 3,4 don't
                mamba_layers.append(
                    MambaLayer(
...
# original UMambaEnc_3d
# FLOPs: 1098.166465088 GFLOPs
# | name                         | #elements or shape   |
# |:-----------------------------|:---------------------|
# | model                        | 23.2M                |
# |  encoder                     |  11.2M               |
# |   encoder.stem               |   84.3K              |
# |    encoder.stem.0            |    28.8K             |
# |    encoder.stem.1            |    55.5K             |
# |   encoder.mamba_layers       |   1.3M               |
# |    encoder.mamba_layers.0    |    10.0K             |
# |    encoder.mamba_layers.1    |    32.8K             |
# |    encoder.mamba_layers.2    |    0.1M              |
# |    encoder.mamba_layers.3    |    0.4M              |
# |    encoder.mamba_layers.4    |    0.7M              |
# |   encoder.stages             |   9.8M               |
# |    encoder.stages.0          |    0.1M              |
# |    encoder.stages.1          |    0.4M              |
# |    encoder.stages.2          |    1.6M              |
# |    encoder.stages.3          |    2.7M              |
# |    encoder.stages.4          |    5.1M              |
# |  decoder                     |  12.0M               |
# |   decoder.stages             |   11.9M              |
# |    decoder.stages.0          |    9.0M              |
# |    decoder.stages.1          |    2.2M              |
# |    decoder.stages.2          |    0.6M              |
# |    decoder.stages.3          |    85.2K             |
# |   decoder.upsample_layers    |   0.1M               |
# |    decoder.upsample_layers.0 |    82.2K             |
# |    decoder.upsample_layers.1 |    32.9K             |
# |    decoder.upsample_layers.2 |    8.3K              |
# |    decoder.upsample_layers.3 |    2.1K              |
# |   decoder.seg_layers         |   11.6K              |
# |    decoder.seg_layers.0      |    6.2K              |
# |    decoder.seg_layers.1      |    3.1K              |
# |    decoder.seg_layers.2      |    1.6K              |
# |    decoder.seg_layers.3      |    0.8K              |

# remove mamba from 3,4 stages.
# FLOPs: 1096.808944 GFLOPs
# | name                         | #elements or shape   |
# |:-----------------------------|:---------------------|
# | model                        | 22.1M                |
# |  encoder                     |  10.1M               |
